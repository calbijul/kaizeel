  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (homePos >= 0 && homePos < window.innerHeight) {
        ...
        aboutPos < window.innerHeight / 2 &&
        aboutPos > -window.innerHeight / 2
      ) {
        setActiveSection("about");
      } else if (
        projectsPos < window.innerHeight / 2 &&
        projectsPos > -window.innerHeight / 2
      ) {
        ...
        <header className="fixed top-0 w-full bg-white dark:bg-gray-900 shadow-sm z-50">
          ...
          <nav className="container mx-auto px-4 sm:px-6 py-4">
            <div className="flex justify-between items-center">
              <h1 className="text-lg sm:text-xl font-extrabold text-gray-800 dark:text-gray-100 tracking-widest">
                KAIZEEL
              </h1>
        ...
        <div className="space-y-0">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl">
                  ...
                  technologies. My focus is on creating efficient, scalable
                  solutions with great user experiences.
                </p>
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tech.map((tech) => (
                        <span
                          key={tech}
                          className="bg-blue-100 border-transparent border-2 dark:bg-blue-900 text-blue-800 dark:text-blue-100 px-3 py-1 rounded-full text-sm hover:bg-blue-300 hover:text-blue-900 hover:border-2 hover:border-blue-900 "
                        >
                          {tech}
                        </span>
                      ))}
          ...
          >
            ...
            >
             ...
             <div className="flex gap-x-30 col-span-4 pt-10 ">
                <div className="w-1/4 ">
                  <a href="mailto:calbijul@gmail.com">
                    <img src="/img/email.png" className="w-30 border-4 hover:border-2  border-transparent rounded-3xl"/>
                  </a>
                </div>
                <div className="w-1/4 ">
                  <a
                  ...
                  >
                    <img src="/img/linkedin.png" className="w-30 border-4 hover:border-2  border-transparent rounded-3xl" />
                  </a>
                </div>
                <div className="w-1/4 ">
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <img src="/img/github.png" className="w-30 border-4 hover:border-2  border-transparent rounded-3xl" />
                  </a>
                </div>
                <div className="w-1/4 ">
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <img src="/img/facebook.png" className="w-30 border-4 hover:border-2  border-transparent rounded-3xl" />
                  </a>
                </div>
              </div>
             </div>
